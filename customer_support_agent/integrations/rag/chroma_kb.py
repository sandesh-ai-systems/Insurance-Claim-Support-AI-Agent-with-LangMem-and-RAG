...
class KnowledgeBaseService:
    ...
    def _build_embedding_function(self) -> Any:
        if self._settings.google_api_key:
            # Chroma's GoogleGenaiEmbeddingFunction reads GEMINI_API_KEY in recent releases.
            ...
            try:
                ...
                raise RuntimeError(
                    "Gemini embedding initialization failed. Install `google-genai` and verify GOOGLE_API_KEY/GEMINI_API_KEY."
                ) from exc
